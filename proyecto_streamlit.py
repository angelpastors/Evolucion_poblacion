...
ciudades_españa_recientes = pd.read_csv("/poblacion/trabajo/ciudades_españa_recientes.csv")
ciudades_españa = pd.read_csv("/poblacion/trabajo/ciudades_españa.csv")
comunidades_autonomas = pd.read_csv("/poblacion/trabajo/comunidades_autonomas.csv")
comunidades_serie_anual = pd.read_csv("/poblacion/trabajo/comunidades_serie_anual.csv")
dataset_mundial = pd.read_csv("n/poblacion/trabajo/dataset_mundial.csv")
dataset_paises = pd.read_csv("/poblacion/trabajo/dataset_paises.csv")
españa_poblacion = pd.read_csv("/poblacion/trabajo/españa_poblacion.csv")
paises_actual = pd.read_csv("/poblacion/trabajo/paises_actual.csv")
dataframe_ciudades = pd.read_csv("/poblacion/trabajo/dataframe_ciudades.csv")
dataframe_continentes = pd.read_csv("/poblacion/trabajo/dataframe_continentes.csv")
